...
def cartelera(request):
    ...
    m_mes = {1:'Enero', 2:'Febrero', 3:'Marzo', 4:'Abril', 5:'Mayo',
    ...
    obras = []
    for item in models.Showing.objects.filter(season_end__gte = today).filter(season_start__lte = lastday):
        obra = {}
...
def crear_puesta(request):
    return render( request, 'teatro_peru/crear_puesta.html', {'form': forms.Showing  })
